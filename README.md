THIS IS NO LONGER USED, I AM CREATING A NEW WEBSITE, THIS WILL BECOME An ARCHIVE MAYBE
...
to change the chat servers, change the firebase config. current one:
